...
<Cards>
  <Cards.Card
    ...
    href="/getting-started/claude-code/quick-start"
  >
  ...
  <Cards.Card
    ...
    href="/getting-started/claude-code/how-to"
  >
    探索更多实用教程和高级技巧
  </Cards.Card>
</Cards>
...
详细说明请参考：[SyntaxError 解决方案](/getting-started/claude-code/common-errors/syntax-error-node-version)
