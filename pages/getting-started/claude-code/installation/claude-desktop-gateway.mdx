...
如果你只用 Claude Code CLI，请优先参考 [配置 Base URL 和 Auth Token](/getting-started/claude-code/faq/config-baseurl-authtoken)。
...
- [配置 Base URL 和 Auth Token](/getting-started/claude-code/faq/config-baseurl-authtoken) — Claude Code CLI 视角的三种配置方式
