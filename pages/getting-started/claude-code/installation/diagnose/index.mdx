...
- **🍎 macOS**：[macOS 手动排查指南](/getting-started/claude-code/installation/diagnose/macos)
- **🪟 Windows**：[Windows 手动排查指南](/getting-started/claude-code/installation/diagnose/windows)

### 🎓 不熟悉终端？

如果你不熟悉使用命令行（终端或 PowerShell），请查看我们的新手入门指南：

- **[终端基础入门教程](/getting-started/claude-code/installation/diagnose/terminal-basics)**：学习如何在 macOS 和 Windows 上打开和使用终端。
