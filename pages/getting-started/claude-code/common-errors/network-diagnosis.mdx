...
详细设置方法请参考：
- [macOS 设置环境变量](/getting-started/claude-code/installation/macos#3-设置环境变量)
- [Windows 设置环境变量](/getting-started/claude-code/installation/windows#3-设置环境变量)
- [Linux 设置环境变量](/getting-started/claude-code/installation/linux#3-设置环境变量)
