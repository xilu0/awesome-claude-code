...
<Steps>
  ...
  访问 [获取 API Key](/getting-started/claude-code/get-api-key) 页面了解如何获取 CC Club 的 API Key。
...
<Steps>
  ...
  **配置渠道信息**
  ...
  - **渠道名称**：CC Club（或自定义名称）
  - **代理地址**：填写 CC Club 的 API 地址（参考 [CC Club API 地址](/getting-started/claude-code/get-api-key)）
...
A: 请访问 [获取 API Key](/getting-started/claude-code/get-api-key) 页面了解如何获取密钥。
